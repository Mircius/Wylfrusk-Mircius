...
--
-- Servidor: localhost
-- Tiempo de generación: 19-12-2017 a las 16:08:48
...
(1, 'José', 'González Castillo', 'JotaGonzalez', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'jgonzalezc.crn@artsgrafiques.org', 42),
(2, 'Sergi', 'Coma Corcuera', 'Scoma', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'scomacorcuera@iesesteveterradas.cat', 42),
(3, 'Alvaro', 'Delgado Rioja', 'Adelgado', '654321', 'adelagadorioja@gmail.com', 0),
(4, NULL, NULL, NULL, NULL, 'locotedelacolina@gmail.com', 0),
(5, 'Test', 'test', 'test', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'test@test.com', 0);
...
--
ALTER TABLE `Invitacion`
  MODIFY `ID_Invitacion` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `Opcion`
--
ALTER TABLE `Opcion`
  MODIFY `ID_Opcion` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
